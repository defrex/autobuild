...
Only the Fontsource subset blocks that contain the fixed scenario's samples are included. The original SIL Open Font License notices are checked in alongside the fonts.
