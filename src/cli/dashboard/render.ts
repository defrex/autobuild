...
function renderBuild(
  ...
  // the slug is the flexible/truncatable identity segment, and the right
  // cluster hugs `width` so status ends at the same column on every row.
  ...
  // The slug is the sole flexible segment; narrow frames truncate it before
  // the right-pinned lifecycle status.
