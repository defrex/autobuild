...
export const HELP_CATALOG: readonly HelpEntry[] = [
  ...
  },
  {
    ...
    detail: page([
      ...
      '          [--forge github|local-git]',
      '          [--ticket-source file|linear]',
      '          [--workspace-provider git-worktree]',
      '          [--role-profile split|<registered-runtime>] [--no-interactive]',
      '',
      ...
      'On a TTY, first-time init prompts for unresolved forge, ticket, workspace, and role choices.',
      'Use Up/Down to move and Enter to confirm; answered choices remain visible in collapsed form.',
      'Ctrl+C cancels before autobuild.toml or vendored skills are written.',
      'Each selection flag suppresses its corresponding prompt; specifying all four is prompt-free.',
      ...
      'On reruns, init preserves the config and ignores all adapter-selection flags.',
