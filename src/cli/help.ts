...
export const HELP_CATALOG: readonly HelpEntry[] = [
  ...
  },
  {
    ...
    detail: page([
      ...
      'path, a non-Git target, and an in-progress Git operation suppress the commit',
      'with a warning. A staging or commit failure restores the pre-attempt index',
      'without touching merged files or changing upgrade’s merge-derived exit status.',
