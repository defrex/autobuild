...
export const HELP_CATALOG: readonly HelpEntry[] = [
  ...
  },
  {
    ...
    detail: page([
      ...
      '          [--role-profile split|claude|codex|pi] [--no-interactive]',
      '',
      ...
      'On a TTY, first-time init prompts for unresolved ticket, workspace, and role choices.',
      ...
      '--no-interactive preserves the historical template defaults without prompting.',
