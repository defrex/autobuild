...
export const HELP_CATALOG: readonly HelpEntry[] = [
  ...
  },
  {
    ...
    detail: page([
      ...
      'store that cannot be opened at start exit 1 with a message on stderr. A store read that',
      'fails after the watch has started is reported once on stderr and retried at the next',
      'interval without ending the watch or duplicating or skipping any event.',
      '',
  ...
  },
  {
    ...
    detail: page([
      ...
      'in-flight holds promptly. A store read that fails while waiting is reported once on',
      'stderr, retried at the next interval (the next request on the remote path), and never',
