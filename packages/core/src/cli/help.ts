...
export const HELP_CATALOG: readonly HelpEntry[] = [
  ...
  },
  {
    ...
    detail: page([
      ...
      '  ab artifact download-repo <kind>[@rev] --output <file> [--store <ref>]',
      '',
      ...
      '',
      'download-repo is the repository-scoped form: it retrieves bytes deposited on',
      'the repository journal scope, such as the finalized stream:<id> documents of',
      'closed harvest session streams. Authority mirrors download: operator-wide',
      'without identity; with an ambient Harvest tuple only the own repository;',
      'with an ambient build tuple denied. Find stream ids and open/closed status',
      'in the per-session rows of ab harvest status.',
    ]),
  },
  {
    name: 'observe',
